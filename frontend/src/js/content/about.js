  ...
  return (
    ...
    <div className="col-12" align="center">
      ...
      <div className="card-body text-justify">
        ...
        <p>I dreamed about going to Harvard since I was thirteen years old. After I graduated from UBC, my professors encouraged me to apply to my dream school for my graduate studies, and I was accepted with a full scholarship. I have lectured as head of a writing program at a university, worked at the United Nations, trained as a counsellor at the Red Cross, as well as advised businesses in finance.</p>
        <p> I ran an educational consulting business for over seven years while I was working full-time, and I never gave it up because I found helping students achieve their dreams so rewarding. In response to our rapidly changing world, I wanted to gain experience in the technology sector, so I took a 10-week coding bootcamp course and built this website using coding languages and technology that I had never used before.</p>
        <p> I am now excited to learn more about Data Science and Machine Learning, and how it can improve education.</p>
      </div>
    </div>
    </div>
  );
