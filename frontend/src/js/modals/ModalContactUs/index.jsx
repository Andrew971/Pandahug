...
import {ContactAction} from '../../../Redux/Modules/contact';
...
class ModalContactUs extends Component {
  ...
  render() {
    ...
    return (<div>
      <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style={{
          borderRadius: '40rem'
        }}>
...
export default withRouter(connect(mapStateToProps)(ModalContactUs));
