          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                ...
                <button type="button" className="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#exampleModalCenter"
                  onClick={() => { this.props.contactForm(this.contactForm.userName.value, this.contactForm.age.value, this.contactForm.email.value, this.contactForm.phone.value, this.contactForm.language.value, this.contactForm.comments.value) }}>Save changes</button>
              </div>
            </div>
          </div>
        </div>
