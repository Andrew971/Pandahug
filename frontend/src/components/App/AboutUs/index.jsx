...
import grad1 from '../../../Assets/images/grad1.jpg';
import './index.css';
import ChatbotAbout from '../ChatbotAbout';
...
export default class AboutUs extends Component {
        ...
        <div className="container-fluid">
            ...
            <div class="card-deck">
            <div className="card">
                <img className="card-img-top" id="cardprepareicon" src={prepareicon} alt="Card image cap" />
            ...
            <div className="card">
              <img className="card-img-top" id="cardapplyicon" src={applyicon} alt="Card image cap" />
              <div className="card-body">
            ...
            <div className="card">
              <img className="card-img-top" id="cardsucceedicon" src={succeedicon} alt="Card image cap" />
              <div className="card-body">
